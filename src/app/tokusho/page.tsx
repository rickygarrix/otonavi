    ...
    <div className="max-w-3xl mx-auto px-6 py-12 text-slate-800">
      ...
      <div className="space-y-6 leading-relaxed text-[15px]">
        ...
        <section>
          ...
          <p>
            各サービスページに記載します。
            サブスクリプション（月額課金）を提供する場合、適宜その料金を表示します。
          </p>
        </section>

        <section>
          <h2 className="font-semibold mb-2">商品代金以外の必要料金</h2>
          <p>インターネット接続にかかる通信料は利用者負担となります。</p>
        </section>
        ...
        <section>
          <h2 className="font-semibold mb-2">返品・キャンセル</h2>
          <p>
            デジタルコンテンツの特性上、購入後の返金には応じられません。
            サブスクを解約した場合でも、支払い済みの料金は返金できません。
          </p>
        </section>
