  ...
  return (
    <div className="bg-light-1 text-dark-5 -mt-20">
      ...
      <main>
        ...
        <form className="bg-light-2 flex flex-col gap-4 px-6 pt-10 pb-20" onSubmit={(e) => e.preventDefault()}>
          {displayFields.map((f) => (
          ...
          <label className="outline-light-5 flex items-center gap-4 rounded-lg p-4 text-sm outline outline-1 cursor-pointer">
            <input
              type="checkbox"
              checked={agreed}
